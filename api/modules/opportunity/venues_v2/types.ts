...
export const opportunityVenuesV2Include = {
  theme: true,
  themeVariant: true,
} as const;

export type EnrichableOpportunityVenuesV2 = Prisma.OpportunityVenuesV2GetPayload<{
  include: typeof opportunityVenuesV2Include;
}>;
