...
export const opportunityRouteV2Include = {
  theme: true,
  themeVariant: true,
} as const;

export type EnrichableOpportunityRouteV2 = Prisma.OpportunityRouteV2GetPayload<{
  include: typeof opportunityRouteV2Include;
}>;
